...
export const Logo: React.FC<IconSvgProps> = ({
    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width={size || width}
         height={size || height}
         viewBox={`0 0 ${size} ${size}`} {...props} >
        <image id="图层_1" width={size} height={size} xlinkHref="./logo.svg"/>
    </svg>
);
